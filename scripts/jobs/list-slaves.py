...
PARTITIONS = DIR / "partitions.conf"
SLAVES = DIR / "slaves.conf"
MASTER = DIR / "master.conf"
...
def main():
    ...
    print("# Slave registry (from slaves.conf + partitions.conf)")
    ...
    if not slaves:
        print("(empty — edit scripts/jobs/slaves.conf)")
